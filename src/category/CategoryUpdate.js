...
const CategoryUpdate = () => {
    ...
    useEffect(() => {
        // 부모 카테고리 목록 가져오기
        axios.get('https://fitinside.duckdns.org/api/categories', {
            headers: {
        ...
        // 선택된 카테고리 정보 가져오기
        axios.get(`https://fitinside.duckdns.org/api/categories/${id}`, {
            headers: {
                'Authorization': `Bearer ${localStorage.getItem('token')}`
            }
        })
    ...
    const handleSubmit = (e) => {
        ...
        axios.put(`https://fitinside.duckdns.org/api/admin/categories/${id}`, formData, {
            headers: {
                'Authorization': `Bearer ${localStorage.getItem('token')}`,
