...
const ProductUpdate = () => {
    ...
    const deleteProductImages = async () => {
        try {
            ...
            if (imageUrlsToDelete.length > 0) {
                await axios.delete(
                    `http://fitinside.duckdns.org:8080/api/admin/products/${id}/images`,
                    {
            ...
            if (descImageUrlsToDelete.length > 0) {
                await axios.delete(
                    `http://fitinside.duckdns.org:8080/api/admin/products/${id}/description-images`,
                    {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // 상품 업데이트 요청
            await axios.put(`http://fitinside.duckdns.org:8080/api/admin/products/${id}`, formData, {
                headers: {
