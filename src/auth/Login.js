...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('https://fitinside.duckdns.org/api/auth/login', {
                email,
                password
            },
                {
    ...
    const handleGoogleLogin = () => {
        window.location.href = 'https://fitinside.duckdns.org/oauth2/authorization/google';
    };
